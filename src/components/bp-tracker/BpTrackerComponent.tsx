...
// ============================================================
// RemindMe — Blood Pressure Tracker Component (Client-only)
// ============================================================
...
function exportCSV(readings: BpReading[], medicines: BpMedicine[]) {
  ...
  // ── Report Header ─────────────────────────────────────────
  lines.push(`${esc('BLOOD PRESSURE REPORT')},${esc('RemindMe')}`);
...
<body>
  ...
  <div class="header">
    <div class="header-brand">
      ...
      <div>
        ...
        <div class="header-sub">RemindMe · Personal Health Tracker</div>
      </div>
    </div>
  ...
  <!-- Footer -->
  <div class="footer">
    <strong>⚠️ Medical Disclaimer:</strong> This report is generated from self-logged data using RemindMe and is intended for personal reference and sharing with healthcare providers only. It does not constitute medical advice. Always consult a qualified doctor or healthcare professional for diagnosis and treatment.
  </div>
  <div class="print-note">RemindMe — Blood Pressure Report · ${new Date().toLocaleDateString('en-IN')}</div>
      ...
      <div id="bp-print-report" className="hidden" ref={printRef}>
        ...
        <div className="bp-header">
          <div>
            ...
            <div className="bp-subtitle">Generated by RemindMe · Health Tracker</div>
          </div>
