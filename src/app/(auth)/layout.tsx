...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-[100dvh] bg-[var(--bg-base)] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute h-96 w-96 rounded-full bg-[var(--accent)]/15 blur-3xl pointer-events-none" />

      {/* Logo */}
      <Link href="/" className="mb-4 sm:mb-6 flex items-center gap-2">
